    ...
    Route::group(
        ...
        Route::middleware(['adminCheck','loginCheck'])->group(function () {
            ...
            Route::prefix('admin')->group(function () {
                ...
                // OpenAI Processing Routes
                Route::prefix('openai')->group(function () {
                    Route::get('/', [OpenAiController::class, 'index'])->name('openai.index');
                    Route::get('/updateOrCreate', [OpenAiController::class, 'updateOrCreateLang'])->name('openai.updateOrCreate');
                    // Route::get('/generate', [OpenAIController::class, 'generate'])->name('generate');
                    Route::post('/process-json', [OpenAIController::class, 'processJson'])->name('openai.processJson');
                });
                ...
                //         'user' => Auth::guard('web')->user(),  // Try 'admin' if using an admin guard
                //     ]);
                // });
                //dashboard
