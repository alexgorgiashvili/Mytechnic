...
Route::get('/debug-locale', function () {
    return [
        ...
        'localization_supported' => config('laravellocalization.supportedLocales')
    ];
});
...
Route::post('/order/validate', [GeoPaymentController::class, 'validatePaymentOrder']); // Validates and creates order
Route::get('bog/payment/redirect', [GeoPaymentController::class, 'bogPayRedirect']);
Route::post('bog/payment/callback', [GeoPaymentController::class, 'bogPaymentCallback'])->name('bog.payment.callback');

Route::post('/credo/installment/request', [GeoPaymentController::class, 'credoInstallmentRequest']);
Route::get('/credo/installment/status', [GeoPaymentController::class, 'credoInstallmentStatus']);
