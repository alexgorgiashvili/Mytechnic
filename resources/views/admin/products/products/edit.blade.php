                                                ...
                                                <div class="attribute-values">
                                                    ...
                                                    @foreach($selected_attributes as $attribute)
                                                        ...
                                                        <div class="form-group row">
                                                           ...
                                                           : ($product_language->product->selected_variants != null && arrayCheck($attribute->id,$product_language->product->selected_variants) ? (in_array($value->id, $product_language->product->selected_variants[$attribute->id]) ? 'selected' : '') : '') }}>
                                                                            {{ $value->value }}
                                                                        </option>
                                                                    @endforeach
                                                                </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control selectric" name="campaign" id="campaign">
                                                ...
                                                @foreach($campaigns as $campaign)
                                                    <option
                                                            value="{{ $campaign->id }}" {{ old('campaign') == $campaign->id ? 'selected' : (($product_language->productCampaign && $product_language->productCampaign->campaign_id == $campaign->id) ? 'selected' : '')}}>{{ $campaign->getTranslation('title', App::getLocale()) }}</option>
                                                @endforeach
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control selectric" name="campaign_discount_type"
                                                        ...
                                                        <option value=""
                                                                selected>{{ __('Select Discount Type') }}</option>
                                                        <option
                                                                value="flat" {{ old('campaign_discount_type') == 'flat' ? 'selected' : (($product_language->productCampaign && $product_language->productCampaign->discount_type == 'flat') ? 'selected' : '')}}>{{ __('Flat') }}</option>
                                                        <option
                                                                value="percent" {{ old('campaign_discount_type') == 'percentage' ? 'selected' : (($product_language->productCampaign && $product_language->productCampaign->discount_type == 'percentage') ? 'selected' : '')}}>{{ __('Percent') }}</option>
                                                    </select>
